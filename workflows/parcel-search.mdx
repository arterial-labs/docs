...
You can use the _Planning Arguments_ key to filter parcels based on their ability to have variances sought for them_Arterial will conduct HBU studies to search for the places with the highest probability of success.
