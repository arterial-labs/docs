...
<Frame caption="Parcels can be filtered off of development theses.">
	<iframe
		src="https://player.mux.com/PF02lNlmArkhqH8SjqOspxXgrb2cqjlGiE8gp78j46bQ?accent-color=%239c9586&muted=true&voluem=0"
...
<Frame caption="Parcels can be filtered off of basic template compatibility.">
	<iframe
		src="https://player.mux.com/90002anUNTTi4M5eoP1LE008TW5CeKCQNX9a600prVltQvg?accent-color=%239c9586&muted=true&voluem=0"
		allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;"
		allowfullscreen
		className="w-full aspect-video"
	></iframe>
...
<Frame caption="MLS compatibility .">
	<iframe
		src="https://player.mux.com/ar3AvbFfEUpupKTaR021EN7UnKHRiPszY4HQIfwk4Q9Y?accent-color=%239c9586&muted=true&voluem=0"
		allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;"
		allowfullscreen
		className="w-full aspect-video"
	></iframe>
